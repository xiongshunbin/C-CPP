// t6.cpp -- using the Queue interface
...
bool newcustomer(double x);		// is there a new cunstomer?
...
int main()
{
	...
	cin >> hours;
	// simulation of run 1 cycle per minute
	...
	int wait_time1 = 0;		// time1 until autoteller is free
	int wait_time2 = 0;		// time2 until autoteller is free
