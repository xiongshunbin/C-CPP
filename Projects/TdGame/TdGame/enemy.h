...
public:
	...
	void on_update(double delta)
	{
		...
		// 1. 处理enemy的移动，分别对enemy的位置，方向和速度进行更新
...
private:
	Vector2 position;	// 中心点位置矢量
	Vector2 velocity;	// 速度矢量，速度矢量 = 速度 * 方向矢量
	Vector2 direction;	// 方向矢量，表示的是某一方向上的单位向量
	...
	int idx_target = 0;
	Vector2 position_target;	// 下一个目标位置矢量坐标
